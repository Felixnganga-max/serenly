...
// Shared blog post data — sample/hardcoded posts. Replace with dashboard-driven
// content later; the slug is the stable public identifier used in /blogs/:slug.
...
Start here. Stay consistent. Add channels only when your current ones are working. Serenly helps small businesses in Nairobi build this foundation correctly from day one.
  ...
  {
    id: 11,
    slug: "seo-strategies-dominating-kenyan-search-2026",
    featured: false,
    img: IMGS.seo,
    category: "Digital Marketing",
    tags: ["SEO Kenya", "Google Ranking"],
    date: "January 15, 2026",
    readTime: "5 min read",
    title: "5 SEO Strategies Dominating Kenyan Search in 2026",
    excerpt:
      "As Google's algorithm evolves, these five strategies are separating page-one brands from everyone else in Kenya's digital landscape.",
    metaTitle: "5 SEO Strategies Dominating Kenyan Search in 2026 | Serenly",
    metaDesc:
      "The five SEO strategies separating page-one Kenyan brands from everyone else in 2026 — from technical audits to buyer-intent keyword targeting.",
    keywords: [
      "seo strategies kenya",
      "seo trends 2026",
      "google ranking kenya",
      "seo company nairobi",
    ],
    content: `
Kenyan search behaviour keeps shifting, and the brands ranking on page one in 2026 are the ones adapting fastest. Here are the five strategies making the biggest difference right now.

**1. Technical SEO as a foundation, not an afterthought**
Site speed, mobile-first indexing, and clean structured data are non-negotiable baseline requirements — not advanced tactics.

**2. Buyer-intent keyword targeting**
Ranking for high-volume, low-intent terms rarely converts. Kenyan brands winning right now are targeting the specific phrases people search right before they buy.

**3. Local SEO domination**
Google Business Profile optimisation, local citations, and location-specific landing pages are compounding for Nairobi and East African businesses that invest early.

**4. Content built for authority, not just volume**
Depth and originality beat thin, templated blog posts every time in 2026's search landscape.

**5. Every new site launched SEO-ready from day one**
The brands compounding fastest never had to retrofit SEO — it was built into the site from the first line of code.
    `.trim(),
  },
  {
    id: 12,
    slug: "instagram-reels-highest-roi-format-kenyan-brands",
    featured: false,
    img: IMGS.social,
    category: "Social Media",
    tags: ["Instagram Kenya", "Reels", "Social Media Marketing"],
    date: "January 8, 2026",
    readTime: "5 min read",
    ...
    metaTitle:
      "Why Instagram Reels Are the Highest-ROI Format for Kenyan Brands | Serenly",
    metaDesc:
      "Short-form video is outperforming static posts across every metric for Kenyan brands. Here's why Instagram Reels deliver the highest ROI in 2026.",
    keywords: [
      "instagram reels kenya",
      "instagram marketing kenya",
      "social media roi",
      "short form video marketing",
    ],
    content: `
Static posts still have a place, but the numbers no longer lie: Instagram Reels are outperforming every other content format for Kenyan brands on reach, engagement, and — most importantly — conversion.

**Why Reels win the algorithm**
Meta actively prioritises short-form video distribution, pushing Reels to non-follower audiences far more aggressively than static posts or carousels.

**Lower cost per engagement**
Brands running Reels-first content calendars are seeing meaningfully lower cost-per-engagement compared to static-post-heavy strategies.

**Reels build discoverability, not just engagement**
Because Reels reach non-followers by design, they've become the highest-leverage top-of-funnel tool for Kenyan brands trying to grow beyond their existing audience.

Serenly builds Reels-first content calendars for every Meta Ads client — because the format that gets discovered is the format that grows revenue.
    `.trim(),
  },
  {
    id: 13,
    slug: "mpesa-integration-guide-kenyan-ecommerce-2026",
    featured: false,
    img: IMGS.ecom,
    category: "Web Development",
    tags: ["M-Pesa", "E-Commerce Kenya", "Web Development"],
    date: "December 22, 2025",
    readTime: "7 min read",
    title:
      "M-Pesa Integration: The Complete Guide for Kenyan E-Commerce in 2026",
    excerpt:
      "From Daraja API setup to UX best practices — everything your store needs to accept M-Pesa payments flawlessly.",
    metaTitle:
      "M-Pesa Integration: The Complete Guide for Kenyan E-Commerce | Serenly",
    metaDesc:
      "Everything your Kenyan e-commerce store needs for flawless M-Pesa payments in 2026 — Daraja API setup, checkout UX, and common pitfalls to avoid.",
    keywords: [
      "mpesa integration",
      "daraja api",
      "kenyan e-commerce",
    ...
    content: `
For Kenyan e-commerce, M-Pesa isn't an optional payment method — it's the default expectation. A store without a flawless M-Pesa checkout loses sales at the final step, every time.

**Getting the Daraja API setup right**
Safaricom's Daraja API powers STK Push and C2B integrations. Getting the callback handling and transaction verification right the first time avoids the silent payment failures that quietly cost stores revenue.

**Checkout UX that reduces abandonment**
The best-converting Kenyan stores keep the M-Pesa prompt inline, show real-time payment status, and never make the customer leave the checkout page to complete payment.

**Common pitfalls**
Unverified callback URLs, missing timeout handling, and unclear "payment pending" states are the most common reasons M-Pesa checkouts quietly leak sales.

Serenly builds M-Pesa integration into every e-commerce project from day one — not bolted on after launch.
    `.trim(),
  },
];
...
// Most recent posts, used on the Home page's blog teaser section
export const LATEST_POSTS = ALL_POSTS.slice(0, 3);

export { IMGS, ALL_POSTS, STAFF_PICKS, CATEGORIES };
